...
Below, we remove the unnecessary columns, keeping the country, capital, and coordinates, and then combine the new data with our existing Plastic Waste data set.
...
api_key <- "8WgZLi4HWZgdRb41628puOGlpbB1OOu1PT7nMJF3"
